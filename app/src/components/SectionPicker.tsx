        ...
        >
            <div>
                <select
                    id={"search-by"}
                    className={
                        "bg-sky-500 hover:bg-sky-400 border border-blue-300 text-white text-sm rounded-lg p-2.5 mr-1 dark:bg-blue-600 dark:text-stone-300 dark:border-neutral-700"
                    }
                ...
                <input
                    ...
                    type={"text"}
                    className={
                        "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg p-2.5 mb-0.5 dark:bg-blue-600 dark:border-neutral-700"
                    }
                ...
                <button
                    ...
                    className="bg-sky-500 hover:bg-sky-400 border border-blue-300 text-white text-sm rounded-lg p-2.5 ml-1 dark:bg-blue-600 dark:text-stone-300 dark:border-neutral-700"
                >
                    Search
                </button>
            </div>
